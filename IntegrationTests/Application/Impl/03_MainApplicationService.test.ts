...
test("start_IsAllowedGitPullRequestEventTypeFalse_ActionResultFalse_Ok", async () => {
    ...
    expect(FakeActionResultWrapperRepositoryService.Message).toBe("Hotfix branch merge is not allowed: Git pull request event type is not allowed");
});
